...
public class ManagementPortalDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ManagementPortalGlobalFeatureConfigurator.Configure();
        ManagementPortalModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ManagementPortalDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ManagementPortalResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/ManagementPortal");

            options.DefaultResourceType = typeof(ManagementPortalResource);
        ...
        {
            options.MapCodeNamespace("ManagementPortal", typeof(ManagementPortalResource));
        });
    }
}
