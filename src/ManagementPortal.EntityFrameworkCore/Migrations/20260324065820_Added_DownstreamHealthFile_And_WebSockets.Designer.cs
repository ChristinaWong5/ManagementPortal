...
{
    [DbContext(typeof(ManagementPortalDbContext))]
    [Migration("20260324065820_Added_DownstreamHealthFile_And_WebSockets")]
    partial class Added_DownstreamHealthFile_And_WebSockets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManagementPortal.DownloaderWebSockets.DownloaderWebSocket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("AppDownloaderWebSockets", (string)null);
                });

            modelBuilder.Entity("ManagementPortal.Downloaders.Downloader", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("DownloaderEnabled")
                        .HasColumnType("INTEGER")
                        .HasColumnName("DownloaderEnabled");

                    b.Property<string>("DownloaderPollarName")
                        .HasColumnType("TEXT")
                        .HasColumnName("DownloaderPollarName");

                    b.Property<string>("DownstreamHealthFile")
                        .HasColumnType("TEXT")
                        .HasColumnName("DownstreamHealthFile");
                    ...
                    b.ToTable("AppDownloaders", (string)null);
                });
            ...
            modelBuilder.Entity("ManagementPortal.DownloaderWebSockets.DownloaderWebSocket", b =>
                {
                    b.HasOne("ManagementPortal.Downloaders.Downloader", null)
                        .WithMany("DownloaderWebSockets")
            ...
            modelBuilder.Entity("ManagementPortal.Downloaders.Downloader", b =>
                {
                    b.Navigation("DownloaderWebSockets");
                });
