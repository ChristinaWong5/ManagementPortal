...
public class ManagementPortalDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ManagementPortalDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
