...
```
127.0.0.1 configtest-local-web
127.0.0.1 configtest-local-webgateway
127.0.0.1 configtest-local-authserver
```
...
Now, you can browse the URL: `https://configtest-local-web`
